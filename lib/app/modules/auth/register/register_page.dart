...
class _RegisterPageState extends State<RegisterPage> {
  ...
  final _confirmPaswordEC = TextEditingController();

  @override
  void dispose() {
    _emailEC.dispose();
    _passwordEC.dispose();
    _confirmPaswordEC.dispose();
    super.dispose();
  }
              ...
              child: Column(
                children: [
                  ...
                  TodoListFild(
                    ...
                    controller: _confirmPaswordEC,
                    obscureText: true,
                    validator: Validatorless.multiple([
                      Validatorless.required('Confirma senha obrigatório'),
                      Validatorless.compare(_passwordEC, 'Senhas divergentes')
                    ]),
                  ),
                  const SizedBox(
                    height: 20,
